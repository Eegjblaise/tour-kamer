...
<html lang="en">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    ...
    <div class="hero-wrap js-fullheight" style="background-image: url('images/des/ovive2.jpg');">
      <div class="overlay"></div>
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-9 ftco-animate text-center" data-scrollax=" properties: { translateY: '70%' }">
            <p class="breadcrumbs" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><span class="mr-2"><a href="index.php">Accueil</a></span> <span class="mr-2"><a href="restau.php">restau</a></span> <span>Description</span></p>
        		...
        		<div class="sidebar-wrap bg-light ftco-animate">
        			...
        			<form action="#">
		              ...
		              <div class="form-group">
		                <input type="text" class="form-control" placeholder="Nom un restaurant">
		              </div>
		              <div class="form-group">
          ...
          <div class="col-lg-9">
          	<div class="row">
          		<div class="col-md-12 ftco-animate">
					  ...
					  <div class="item">
          					<div class="hotel-img" style="background-image: url(images/des/ovive.jpg);"></div>
          				</div>
          				<div class="item">
          					<div class="hotel-img" style="background-image: url(images/des/ovive1.jpg);"></div>
          				</div>
          				<div class="item">
          					<div class="hotel-img" style="background-image: url(images/des/ovive2.jpg);"></div>
          				</div>
          			</div>
          		</div>
          		<div class="col-md-12 hotel-single mt-4 mb-5 ftco-animate">
          			<span>Nos meilleurs restaurants </span>
          			<h2>restaurant au Cameroun</h2>
          			<p class="rate mb-5">
          		...
          		<div class="col-md-12 hotel-single ftco-animate mb-5 mt-4">
          			...
          			<div class="block-16">
		              <figure>
		                <img src="images/des/ovive3.jpg" alt="Image placeholder" class="img-fluid">
		                <a href="video/3" class="play-button popup-vimeo"><span class="icon-play"></span></a>
		              </figure>
		            </div>
          		</div>
          		<div class="col-md-12 hotel-single ftco-animate mb-5 mt-4">
          			<h4 class="mb-4">Sites similaires</h4>
