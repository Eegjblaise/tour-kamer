...
<html lang="en">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    ...
    <div class="hero-wrap js-fullheight" style="background-image: url('images/descrip/akwa/pisicine4.jpg');">
      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-9 ftco-animate text-center" data-scrollax=" properties: { translateY: '70%' }">
            ...
            <h1 class="mb-3 bread" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Hotels Akwa</h1>
          </div>
        </div>
      </div>
    </div>
          	...
          	<div class="row">
          		<div class="col-md-12 ftco-animate">
          			<div class="single-slider owl-carousel">
          				<div class="item">
          					<div class="hotel-img" style="background-image: url(images/descrip/akwa/4.jpg);"></div>
          				</div>
          				<div class="item">
          					<div class="hotel-img" style="background-image: url(images/descrip/akwa/5.jpg);"></div>
          				</div>
          				<div class="item">
          					<div class="hotel-img" style="background-image: url(images/descrip/akwa/PISCINE.jpg);"></div>
          				</div>
						  <div class="item">
          					<div class="hotel-img" style="background-image: url(images/descrip/akwa/sport1.jpg);"></div>
          				</div>
          			</div>
          		</div>
          		<div class="col-md-12 hotel-single mt-4 mb-5 ftco-animate">
          			...
          			<p class="rate mb-5">
          				...
          				<span class="star">
    						...
    						<p>Doté d'une piscine extérieure, l'AKWA PALACE Douala vous accueille à Douala.</p>
    						<div class="d-md-flex mt-5 mb-5">
    							<ul>
	    							<li>Il propose un centre de remise en forme et une terrasse. Une connexion Wi-Fi est disponible gratuitement.</li>
          		...
          		<div class="col-md-12 hotel-single ftco-animate mb-5 mt-4">
          			...
          			<div class="block-16">
		              <figure>
		                <img src="video/img/akw.jpg" alt="Image placeholder" class="img-fluid">
		                <a href="video/akwa.mp4" class="play-button popup-vimeo"><span class="icon-play"></span></a>
		              </figure>
		            </div>
          		</div>
          		<div class="col-md-12 hotel-single ftco-animate mb-5 mt-4">
          			...
          			<div class="row">
          				<div class="col-md-4">
				    				<div class="destination">
				    					<a href="#" class="img img-2" style="background-image: url(images/descrip/akwa/chambre8.jpg);"></a>
				    					<div class="text p-3">
				    						<div class="d-flex">
				    							<div class="one">
				    						...
				    						<p>Chambre de luxe préparé pour vous.</p>
				    						<hr>
				    						<p class="bottom-area d-flex">
				    							<span><img src="images/site/icon.jpg">akwa</span>
				    			...
				    			<div class="col-md-4">
				    				<div class="destination">
				    					<a href="#" class="img img-2" style="background-image: url(images/descrip/akwa/chambre3.jpg);"></a>
				    					<div class="text p-3">
				    						<div class="d-flex">
				    							<div class="one">
						    						<h3><a href="#">Chambre</a></h3>
				    			...
				    			<div class="col-md-4">
				    				<div class="destination">
				    					<a href="#" class="img img-2" style="background-image: url(images/descrip/akwa/chambre10.jpg);"></a>
				    					<div class="text p-3">
				    						<div class="d-flex">
				    							<div class="one">
						    						<h3><a href="#">Chambre</a></h3>
          		...
          		<div class="col-md-12 hotel-single ftco-animate mb-5 mt-5">
          			...
          			<div class="row">
          				<div class="col-md-4">
				    				<div class="destination">
				    					<a href="hoteldes1.php" class="img img-2" style="background-image: url(images/hotels/maimg1.jpg);"></a>
				    					<div class="text p-3">
				    						<div class="d-flex">
				    							<div class="one">
						    						<h3><a href="hoteldes1.php">hilton</a></h3>
						    						<p class="rate">
						    							<i class="icon-star"></i>
						    							<i class="icon-star"></i>
						    							<i class="icon-star"></i>
