...
<body class="">
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navigation">
        ...
        <li class="nav-item d-flex align-items-center">
          <a class="btn btn-round btn-sm mb-0 btn-outline-white me-2" target="_blank" style="background-color:red;" href="supprimer_site.php">Supprimer un site</a>
        </li>
        <ul class="navbar-nav d-lg-block d-none">
          <li class="nav-item">
            <a href="home.php"  class="btn btn-sm btn-round mb-0 me-1 bg-gradient-light"> page precedente</a>
          </li>
        </ul>
    </div>
  </nav>
  ...
  <main class="main-content  mt-0">
    <section class="min-vh-100 mb-8">
      <div class="page-header align-items-start min-vh-50 pt-5 pb-11 m-3 border-radius-lg" style="background-image: url('../pages/images/3.jpg');">
        ...
        <div class="row mt-lg-n10 mt-md-n11 mt-n10">
          <div class="col-xl-4 col-lg-5 col-md-7 mx-auto">
            <div class="card z-index-0">
              ...
              <div class="form-group">
              <input class="btn btn-primary" name="valider" style="background-color: rgb(62, 211, 248);" placeholder="enregistrer" >
