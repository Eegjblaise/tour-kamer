            ...
            <div class="col-xl-4 col-lg-5 col-md-6  d-flex flex-column mx-auto">
              <div class="card card-plain mt-8">
                <div class="card-header pb-0 text-left bg-transparent">
                  <h3 class="font-weight-bolder text-info text-gradient">Code de Verification</h3>
                </div>
                <div class="card-body">
                <?php 
                  ...
                  <label>Code</label>
                    <div class="mb-3">
                      <input type="number" class="form-control"  name="otp" placeholder="Entrer le code"  required >
                    </div>
                    <div class="text-center">
                      <button type="submit" class="btn bg-gradient-info w-100 mt-4 mb-0" name="login-now">Valider</button>
                    </div>
                  </form>
                </div>
