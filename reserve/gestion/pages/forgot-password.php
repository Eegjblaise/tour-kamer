            ...
            <div class="col-xl-4 col-lg-5 col-md-6  d-flex flex-column mx-auto">
              <div class="card card-plain mt-8">
                <div class="card-header pb-0 text-left bg-transparent">
                  <h3 class="font-weight-bolder text-info text-gradient">Recupere ton mot de passe</h3>
                  <p class="mb-0">Entrer votre adresse Gmail</p>
                </div>
                <div class="card-body">
                  ...
                  <?php
                    ...
                    <div class="text-center">
                      <button type="submit" class="btn bg-gradient-info w-100 mt-4 mb-0" name="check-email">Valider</button>
                    </div>
                  </form>
                </div>
