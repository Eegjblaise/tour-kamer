...
<html lang="en">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    ...
    <div class="hero-wrap js-fullheight" style="background-image: url('images/hotels/marriott1.jpg');">
      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-9 ftco-animate text-center" data-scrollax=" properties: { translateY: '70%' }">
            ...
            <h1 class="mb-3 bread" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Hotels Marriot</h1>
          </div>
        </div>
      </div>
    </div>
          	...
          	<div class="row">
          		<div class="col-md-12 ftco-animate">
          			<div class="single-slider owl-carousel">
          				<div class="item">
          					<div class="hotel-img" style="background-image: url(images/hotels/marriott.jpg);"></div>
          				</div>
          				<div class="item">
          					<div class="hotel-img" style="background-image: url(images/descrip/mariot/restau.jpg);"></div>
          				</div>
          				<div class="item">
          					<div class="hotel-img" style="background-image: url(images/descrip/mariot/chambre1.jpg);"></div>
          				</div>
          			</div>
          		</div>
          		<div class="col-md-12 hotel-single mt-4 mb-5 ftco-animate">
          			<span>Nos meilleurs hotels &amp; chambres</span>
          			<h2>hotel de luxe du cameroun</h2>
          			<p class="rate mb-5">
          				...
          				<span class="star">
    						...
    						<p>Voyagez l’esprit tranquille grâce à notre engagement en matière de propreté. </p>
    						<div class="d-md-flex mt-5 mb-5">
    							<ul>
	    							<li>Réservez pour bénéficier des meilleurs tarifs garantis.</li>
          		...
          		<div class="col-md-12 hotel-single ftco-animate mb-5 mt-4">
          			...
          			<div class="block-16">
		              <figure>
		                <img src="video/img/marriott.jpg" alt="Image placeholder" class="img-fluid">
		                <a href="video/mariot.mp4" class="play-button popup-vimeo"><span class="icon-play"></span></a>
		              </figure>
		            </div>
          		</div>
          		<div class="col-md-12 hotel-single ftco-animate mb-5 mt-4">
          			...
          			<div class="row">
          				<div class="col-md-4">
				    				<div class="destination">
				    					<a href="	https://s.htr.cm/gDXA" class="img img-2" style="background-image: url(images/descrip/mariot/chambre2.jpg);"></a>
				    					<div class="text p-3">
				    						<div class="d-flex">
				    							<div class="one">
						    						<h3><a href="	https://s.htr.cm/gDXA">Chambre</a></h3>
						    						<p class="rate">
						    							<i class="icon-star"></i>
						    							<i class="icon-star"></i>
						    							<i class="icon-star"></i>
				    						...
				    						<p>Toute la beauté réside dans la qualité.</p>
				    						<hr>
				    						<p class="bottom-area d-flex">
				    							<span><img src="images/site/icon.jpg">marriott</span>
				    							<span class="ml-auto"><a href="	https://s.htr.cm/gDXA">reserve</a></span>
				    						</p>
				    					</div>
				    				</div>
				    			</div>
				    			<div class="col-md-4">
				    				<div class="destination">
				    					<a href="	https://s.htr.cm/gDXA" class="img img-2" style="background-image: url(images/descrip/mariot/chambre3.jpg);"></a>
				    					<div class="text p-3">
				    						<div class="d-flex">
				    							<div class="one">
						    						<h3><a href="	https://s.htr.cm/gDXA">Chambre</a></h3>
				    			...
				    			<div class="col-md-4">
				    				<div class="destination">
				    					<a href="	https://s.htr.cm/gDXA" class="img img-2" style="background-image: url(images/descrip/mariot/chambre4.jpg);"></a>
				    					<div class="text p-3">
				    						<div class="d-flex">
				    							<div class="one">
						    						<h3><a href="	https://s.htr.cm/gDXA">Chambre</a></h3>
          				...
          				<div class="col-md-4">
				    				<div class="destination">
				    					...
				    					<div class="text p-3">
				    						...
				    						<p>Hotel convivial avec chambres et piscine exterieure.</p>
				    						<hr>
				    						<p class="bottom-area d-flex">
				    			...
				    			<div class="col-md-4">
				    				<div class="destination">
				    					<a href="hoteldes.php" class="img img-2" style="background-image: url(images/hotels/hotel1.jpg);"></a>
				    					<div class="text p-3">
				    						<div class="d-flex">
				    							<div class="one">
		    						...
		    						<p>L'Hotel Mont febe est situe sur l'une des collines de la ville.</p>
				    						<hr>
				    						<p class="bottom-area d-flex">
				    							<span><img src="images/site/icon.jpg">hotel</span>
				    							<span class="ml-auto"><a href="#">reserve</a></span>
				    			...
				    			<div class="col-md-4">
		    						...
		    						<p>Hotel est situe au coeur du quartier des affaires a Douala.</p>
				    						<hr>
				    						<p class="bottom-area d-flex">
				    							<span><img src="images/site/icon.jpg">hotel</span>
				    							<span class="ml-auto"><a href="#">reserve</a></span>
