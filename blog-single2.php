...
<html lang="en">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    ...
    <div class="hero-wrap js-fullheight" style="background-image: url('images/text/bacchus.jpg');">
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-8 ftco-animate">
            ...
            <p>Le Bacchus est un Restaurant – Bar à vin Suisse qui offre à sa clientèle un très bel espace et lui permet de passer d’agréables moment dans un environnement Cosy.</p>
            <p>
              <img src="images/text/Bacchus3.jpg" alt="" class="img-fluid">
            </p>
            <p>
            Le restaurant, aux couleurs harmonieuses, vous offre tout ce qu’il y a de meilleur dans la restauration Suisse (un mélange de saveurs allemandes, italiennes et françaises).</p>
            <h2 class="mb-3 mt-5">2. Activite Menée</h2>
            <p>Le restaurant – bar à vin Suisse le Bacchus est situé a Yaoundé Elig-Essono, l’entrée avant Mahima (en venant du Centre Ville) à 150m de la route.</p>
            <p>
              <img src="images/text/Bacchus1.jpg" alt="" class="img-fluid">
            </p>
          ...
          <div class="col-md-4 sidebar ftco-animate">
            ...
            <div class="sidebar-box ftco-animate">
              ...
              <div class="block-21 mb-4 d-flex">
                <a class="blog-img mr-4" style="background-image: url(images/text/blog-single1.jpg);"></a>
                <div class="text">
                  <h3 class="heading"><a href="hoteldes1.php">hotel hilton situe au centre du cameroun</a></h3>
                  <div class="meta">
                  </div>
                </div>
              </div>
              <div class="block-21 mb-4 d-flex">
                <a class="blog-img mr-4" style="background-image: url(images/text/1.jpg);"></a>
                <div class="text">
                  <h3 class="heading"><a href="blog-single3.php">Le Musée nationale du cameroun.</a></h3>
                  <div class="meta">
                  </div>
                </div>
              </div>
