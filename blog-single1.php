...
<html lang="en">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    ...
    <div class="hero-wrap js-fullheight" style="background-image: url('images/text/hilton.jpg');">
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-8 ftco-animate">
            ...
            <p>
              <img src="images/text/accueil.jpg" alt="" class="img-fluid">
            </p>
            <p>
            Detendez vous dans une des chambres elegantes du Hilton ,
comprenant toutes un balcon avec vue sur la ville,</p>
            ...
            <p>
              <img src="images/text/recption5.jpg" alt="" class="img-fluid">
            </p>
