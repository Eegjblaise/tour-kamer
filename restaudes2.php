...
<html lang="en">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    ...
    <div class="hero-wrap js-fullheight" style="background-image: url('images/des/s5.jpg');">
          ...
          <div class="col-lg-9">
          	<div class="row">
          		<div class="col-md-12 ftco-animate">
					  ...
					  <div class="item">
          					<div class="hotel-img" style="background-image: url(images/des/s2.jpg);"></div>
          				</div>
          				<div class="item">
          					<div class="hotel-img" style="background-image: url(images/des/s3.jpg);"></div>
          				</div>
          				<div class="item">
          					<div class="hotel-img" style="background-image: url(images/des/s5.jpg);"></div>
          				</div>
          			</div>
          		</div>
          		...
          		<div class="col-md-12 hotel-single ftco-animate mb-5 mt-4">
          			...
          			<div class="block-16">
		              <figure>
		                <img src="images/des/s3.jpg" alt="Image placeholder" class="img-fluid">
		                <a href="video/a" class="play-button popup-vimeo"><span class="icon-play"></span></a>
		              </figure>
		            </div>
          		</div>
          		<div class="col-md-12 hotel-single ftco-animate mb-5 mt-4">
          			<h4 class="mb-4">restaurants similaires</h4>
