          	...
          	<div class="row">
          		<div class="col-md-4 ftco-animate">
		    				<div class="destination">
		    					<a href="hotel-single.php" class="img img-2 d-flex justify-content-center align-items-center" style="background-image: url(images/restaurants/Chez-Wou.jpg);">
		    			...
		    			<div class="col-md-4 ftco-animate">
		    				<div class="destination">
		    					...
		    					<div class="text p-3">
		    						<div class="d-flex">
		    							<div class="one">
				    						<h3><a href="hotel-single.php">Alizane Restaurant</a></h3>
				    						<p class="rate">
				    							<i class="icon-star"></i>
				    							<i class="icon-star"></i>
				    							<i class="icon-star"></i>
		    						...
		    						<p>En ce qui concerne le menu, le restaurant Alizane Restaurant mets a votre disposition des plats de la gastronimie camerounaise et internationale.</p>
		    						<hr>
		    						<p class="bottom-area d-flex">
		    							<span><img src="images/site/icon.jpg">Restaurant</span>
		    							<span class="ml-auto"><a href="#">Découvrir</a></span>
		    			...
		    			<div class="col-md-4 ftco-animate">
		    				<div class="destination">
		    					<a href="hotel-single.php" class="img img-2 d-flex justify-content-center align-items-center" style="background-image: url(images/restaurants/Kathalog-sq_r0k0rPkQrEM.jpg);">
		    						<div class="icon d-flex justify-content-center align-items-center">
    							<span class="icon-search2"></span>
    						</div>
		    					</a>
		    					<div class="text p-3">
		    						<div class="d-flex">
		    							<div class="one">
				    						<h3><a href="hotel-single.php">Restaurant Kathalog</a></h3>
				    						<p class="rate">
				    							<i class="icon-star"></i>
				    							<i class="icon-star"></i>
				    							<i class="icon-star"></i>
		    						...
		    						<p>En ce qui concerne le menu, le restaurant Restaurant Kathalog mets a votre disposition des plats de la gastronimie camerounaise et internationale.</p>
		    						<hr>
		    						<p class="bottom-area d-flex">
		    							<span><img src="images/site/icon.jpg">Restaurant</span>
		    							<span class="ml-auto"><a href="#">Découvrir</a></span>
		    			...
		    			<div class="col-md-4 ftco-animate">
		    				<div class="destination">
		    					<a href="hotel-single.php" class="img img-2 d-flex justify-content-center align-items-center" style="background-image: url(images/restaurants/the_best.jpg);">
		    						<div class="icon d-flex justify-content-center align-items-center">
    							<span class="icon-search2"></span>
    						</div>
		    					</a>
		    					<div class="text p-3">
		    						<div class="d-flex">
		    							<div class="one">
				    						<h3><a href="hotel-single.php">Restaurant The bes</a></h3>
				    						<p class="rate">
				    							<i class="icon-star"></i>
				    							<i class="icon-star"></i>
				    							<i class="icon-star"></i>
