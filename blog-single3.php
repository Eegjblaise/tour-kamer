...
<html lang="en">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    ...
    <div class="hero-wrap js-fullheight" style="background-image: url('images/text/1.jpg');">
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-8 ftco-animate">
            ...
            <p>Le Musée national du Cameroun est logé dans l’ancien palais présidentiel. Ce site historique, lieu de mémoire de l’histoire politique de ce pays, est affecté au Musée national le 17 novembre 1988.</p>
            <p>
              <img src="images/text/Musées.jpg" alt="" class="img-fluid">
            </p>
            <p>
            grâce à une décision du Président de la République du Cameroun, Paul Biya. L’ensemble, étalé sur 15 000m² environ, est constitué d’un édifice central de 5 000m², en surface bâtie, quelques bâtiments annexes et d’un jardin.</p>
            <h2 class="mb-3 mt-5">2. Activite Menée</h2>
            <P>Non loin de cet ensemble royal se trouve une oeuvre considérée comme l'objet phare de la salle : le "ngiii", un masque en bois issu de la société secrète de l'air Fang-béti (régions de l'Est, du Sud et du Centre).

</P>
            <p>La forme de l'oeuvre s'apparente à une combinaison du visage d'une antilope à celui d'un lion. Cet objet symbolise le Nnom Ngiii (chef des chefs).</p>
            <p>
              <img src="images/text/Musée National.jpg" alt="" class="img-fluid">
            </p>
          ...
          <div class="col-md-4 sidebar ftco-animate">
            ...
            <div class="sidebar-box ftco-animate">
              <div class="categories">
                <h3>Categories</h3>
                <li><a href="Tour.php">Tourisme <span></span></a></li>
                <li><a href="hotel.php">Hotel <span></span></a></li>
            ...
            <div class="sidebar-box ftco-animate">
              ...
              <div class="block-21 mb-4 d-flex">
                <a class="blog-img mr-4" style="background-image: url(images/text/can1.jpg);"></a>
                <div class="text">
                  <h3 class="heading"><a href="blog-single.php">Stade Olembe.</a></h3>
                  <div class="meta">
                  </div>
                </div>
              </div>
