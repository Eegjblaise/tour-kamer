...
<html lang="en">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    ...
    <div class="hero-wrap js-fullheight" style="background-image: url('images/descrip/krystal/2.jpg');">
      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-9 ftco-animate text-center" data-scrollax=" properties: { translateY: '70%' }">
            ...
            <h1 class="mb-3 bread" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Hotels Krystal</h1>
          </div>
        </div>
      </div>
    </div>
          	...
          	<div class="row">
          		<div class="col-md-12 ftco-animate">
          			<div class="single-slider owl-carousel">
          				<div class="item">
          					<div class="hotel-img" style="background-image: url(images/descrip/krystal/3.png);"></div>
          				</div>
          				<div class="item">
          					<div class="hotel-img" style="background-image: url(images/descrip/krystal/1.jpg);"></div>
          				</div>
          				<div class="item">
          					<div class="hotel-img" style="background-image: url(images/descrip/krystal/6.jpg);"></div>
          				</div>
          			</div>
          		</div>
          		<div class="col-md-12 hotel-single mt-4 mb-5 ftco-animate">
          			...
          			<p class="rate mb-5">
          				...
          				<span class="star">
    						...
    						<p>
                             Notre hôtel est situé au coeur du quartier des affaires Akwa, à moins de 20 minutes de l'aéroport de Douala.</p>
    						<div class="d-md-flex mt-5 mb-5">
    							<ul>
	    							<li>L’enseigne Krystal Palace Douala est le fruit de la volonté,</li>
	    							<li> d’une famille passionnée par l’industrie de l’hôtellerie de luxe</li>
	    							<li>qui, ayant constaté une absence notoire d’établissements hôteliers </li>
	    							<li>répondant aux, standards internationaux de l’hôtellerie de luxe à Douala. </li>
	    						</ul>
	    						
    						</div>
    						<p>
NB: Profitez d'une vue imprenable du fleuve Wouri à partir de notre bar-bibliothèque Réflexion.
</p>
          		</div>
          		<div class="col-md-12 hotel-single ftco-animate mb-5 mt-4">
        			...
        			<div class="block-16">
		              <figure>
		                <img src="video/img/3.png" alt="Image placeholder" class="img-fluid">
		                <a href="video/kryst.mp4" class="play-button popup-vimeo"><span class="icon-play"></span></a>
		              </figure>
		            </div>
          		</div>
          		<div class="col-md-12 hotel-single ftco-animate mb-5 mt-4">
          			...
          			<div class="row">
          				<div class="col-md-4">
				    				<div class="destination">
				    					<a href="#" class="img img-2" style="background-image: url(images/descrip/krystal/5.jpg);"></a>
				    					<div class="text p-3">
				    						<div class="d-flex">
				    							<div class="one">
				    						...
				    						<p>Univers de la beauté cristallisé.</p>
				    						<hr>
				    						<p class="bottom-area d-flex">
				    							<span><img src="images/site/icon.jpg">Krystal Palace</span>   
				    			...
				    			<div class="col-md-4">
				    				<div class="destination">
				    					<a href="#" class="img img-2" style="background-image: url(images/descrip/krystal/8.jpg);"></a>
				    					<div class="text p-3">
				    						<div class="d-flex">
				    							<div class="one">
						    						<h3><a href="#">Chambre</a></h3>
				    			...
				    			<div class="col-md-4">
				    				<div class="destination">
				    					<a href="#" class="img img-2" style="background-image: url(images/descrip/krystal/4.jpg);"></a>
				    					<div class="text p-3">
				    						<div class="d-flex">
				    							<div class="one">
						    						<h3><a href="#">Chambre</a></h3>
				    			...
				    			<div class="col-md-4">
				    				<div class="destination">
				    					...
				    					<div class="text p-3">
				    						<div class="d-flex">
				    							<div class="one">
						    						<h3><a href="hoteldes2.php">Marriott</a></h3>
						    						<p class="rate">
						    							<i class="icon-star"></i>
						    							<i class="icon-star"></i>
						    							<i class="icon-star"></i>
				    			...
				    			<div class="col-md-4">
				    				<div class="destination">
				    					...
				    					<div class="text p-3">
				    						...
				    						<p>Hotel convivial avec chambres et suites sobres piscine exterieure situe a douala .</p>
				    						<hr>
				    						<p class="bottom-area d-flex">
				    							<span><img src="images/site/icon.jpg">Hotel</span>   
				    							<span class="ml-auto"><a href="#">reserve</a></span>
