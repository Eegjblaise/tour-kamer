...
<html lang="en">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    ...
    <div class="hero-wrap js-fullheight" style="background-image: url('images/des/g4.jpg');">
          ...
          <div class="col-lg-9">
          	<div class="row">
          		<div class="col-md-12 ftco-animate">
					  ...
					  <div class="item">
          					<div class="hotel-img" style="background-image: url(images/des/g3.jpg);"></div>
          				</div>
          				<div class="item">
          					<div class="hotel-img" style="background-image: url(images/des/g2.jpg);"></div>
          				</div>
          				<div class="item">
          					<div class="hotel-img" style="background-image: url(images/des/g1.jpg);"></div>
          				</div>
          			</div>
          		</div>
          		<div class="col-md-12 hotel-single mt-4 mb-5 ftco-animate">
          			...
          			<p class="rate mb-5">
          				...
          				<span class="star">
    						...
    						<p>Les gorges de Kola sont situées sur le territoire de la commune de Guider dans le Nord Cameroun. Les Kola, une tribu Daba du Diamaré dans l'Extrême-Nord du pays, sont les premiers habitants et ont donné leur nom à ce lieu.</p>
          		...
          		<div class="col-md-12 hotel-single ftco-animate mb-5 mt-4">
          			...
          			<div class="block-16">
		              <figure>
		                <img src="images/des/g4.jpg" alt="Image placeholder" class="img-fluid">
