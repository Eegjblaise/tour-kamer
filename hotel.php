      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-9 ftco-animate text-center" data-scrollax=" properties: { translateY: '70%' }">
            <p class="breadcrumbs" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><span class="mr-2"><a href="index.php">Accueil</a></span> <span>HotelS</span></p>
          	...
          	<div class="row">
          		<div class="col-md-4 ftco-animate">
		    				<div class="destination">
		    					<a href="hoteldes.php" class="img img-2 d-flex justify-content-center align-items-center" style="background-image: url(images/hotels/Hotel1.jpg);">
		    					...
		    					<div class="text p-3">
		    						<div class="d-flex">
		    							<div class="one">
				    						<h3><a href="hoteldes.php">Mont Febe</a></h3>
				    						<p class="rate">
				    							<i class="icon-star"></i>
				    							<i class="icon-star"></i>
				    							<i class="icon-star"></i>
			    						...
			    						<div class="two">
			    							<span class="price per-price">83151F<br><small>/nuit</small></span>
		    							</div>
		    						</div>
		    						<p>L'Hotel Mont febe est situe a une altitude de 950m sur l'une des collines de la ville</p>
		    						<hr>
		    						<p class="bottom-area d-flex">
		    							<span><img src="images/site/icon.jpg"> hotel</span>  
		    							<span class="ml-auto"><a href="hoteldes.php">reserve</a></span>
		    						</p>
		    					</div>
		    				</div>
		    			</div>
		    			<div class="col-md-4 ftco-animate">
		    				<div class="destination">
		    					<a href="hoteldes2.php" class="img img-2 d-flex justify-content-center align-items-center" style="background-image: url(images/hotels/marriott.jpg);">
		    						<div class="icon d-flex justify-content-center align-items-center">
    							<span class="icon-search2"></span>
    						</div>
		    					</a>
		    			...
		    			<div class="col-md-4 ftco-animate">
		    				<div class="destination">
		    					<a href="hoteldes1.php" class="img img-2 d-flex justify-content-center align-items-center" style="background-image: url(images/hotels/maimg1.jpg);">
		    						<div class="icon d-flex justify-content-center align-items-center">
    							<span class="icon-search2"></span>
    						</div>
		    					</a>
		    					<div class="text p-3">
		    						<div class="d-flex">
		    							<div class="one">
				    						<h3><a href="hoteldes.php">Hilton</a></h3>
				    						<p class="rate">
				    							<i class="icon-star"></i>
				    							<i class="icon-star"></i>
				    							<i class="icon-star"></i>
		    			...
		    			<div class="col-md-4 ftco-animate">
		    				<div class="destination">
		    					<a href="hoteldes5.php" class="img img-2 d-flex justify-content-center align-items-center" style="background-image: url(images/hotel/syndicat_travailleur.jpg);">
		    						<div class="icon d-flex justify-content-center align-items-center">
    							<span class="icon-search2"></span>
    						</div>
		    					</a>
		    					<div class="text p-3">
		    						<div class="d-flex">
		    							<div class="one">
				    						<h3><a href="hoteldes5.php">Sawa</a></h3>
				    						<p class="rate">
				    							<i class="icon-star"></i>
				    							<i class="icon-star"></i>
				    							<i class="icon-star"></i>
			    						...
			    						<div class="two">
			    							<span class="price per-price">103050F<br><small>/nuit</small></span>
		    							</div>
		    						</div>
		    						<p>Occupant un bâtiment de 8 étages cet Hotel de style decontracte se trouve a 7km de l'aeroport.</p>
		    						<hr>
		    						<p class="bottom-area d-flex">
		    							<span><img src="images/site/icon.jpg"> hotel</span>  
		    							<span class="ml-auto"><a href="#">reserve</a></span>
		    			...
		    			<div class="col-md-4 ftco-animate">
		    				<div class="destination">
		    					<a href="hoteldes4.php" class="img img-2 d-flex justify-content-center align-items-center" style="background-image: url(images/hotels/KRISTAL.png);">
		    						<div class="icon d-flex justify-content-center align-items-center">
    							<span class="icon-search2"></span>
    						</div>
		    					</a>
		    					<div class="text p-3">
		    						<div class="d-flex">
		    							<div class="one">
				    						<h3><a href="hoteldes4.php">Krystal palace</a></h3>
				    						<p class="rate">
				    							<i class="icon-star"></i>
				    							<i class="icon-star"></i>
				    							<i class="icon-star"></i>
		    						...
		    						<p>Notre hotel est situe au coeur du quartier des affaires Akwa la capital economique du Cameroun.</p>
		    						<hr>
		    						<p class="bottom-area d-flex">
		    							<span><img src="images/site/icon.jpg"> hotel</span>  
		    							<span class="ml-auto"><a href="#">reserve</a></span>
		    			...
		    			<div class="col-md-4 ftco-animate">
		    				<div class="destination">
		    					<a href="hoteldes3.php" class="img img-2 d-flex justify-content-center align-items-center" style="background-image: url(images/hotels/imf.jpg);">
		    						<div class="icon d-flex justify-content-center align-items-center">
    							<span class="icon-search2"></span>
    						</div>
		    					</a>
		    					<div class="text p-3">
		    						...
		    						<p>Hotel convivial avec chambres et suites sobres piscine exterieure et un personnel multilinguisme.</p>
		    						<hr>
		    						<p class="bottom-area d-flex">
		    							<span><img src="images/site/icon.jpg"> hotel</span>  
		    							<span class="ml-auto"><a href="#">reserve</a></span>
		          ...
		          <div class="col text-center">
		            <div class="block-27">
		              <ul>
		                ...
		                <li><a href="hotel3.php">4</a></li>
		                <li><a href="hotel4.php">5</a></li>
		                <li><a href="hotel1.php">&gt;</a></li>
		              </ul>
		            </div>
		          </div>
		        </div>
