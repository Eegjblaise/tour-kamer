...
<body>
    ...
    <div class="bg-img">
      <div class="content">
        <header> l'email et le pass de l'admis</header>
        <?php
                    if(count($errors) == 1){
                        ?>
        ...
        <div class="link login-link text-center">etez vous deja inscrit? <a href="login-user.php">connectez vous!</a></div>
        <div class="link login-link text-center">je renonce<a href="http://localhost/test/projet1/8-CarRepair/Dashio/kamer.php?s=e3#">retour!</a></div>
      </div>
    </div>
</body>
</html>