...
<html lang="en">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    ...
    <div class="hero-wrap js-fullheight" style="background-image: url('images/descrip/sawa/0.jpg');">
      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-9 ftco-animate text-center" data-scrollax=" properties: { translateY: '70%' }">
            ...
            <h1 class="mb-3 bread" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Hotels Sawa</h1>
          </div>
        </div>
      </div>
    </div>
          	...
          	<div class="row">
          		<div class="col-md-12 ftco-animate">
          			<div class="single-slider owl-carousel">
          				<div class="item">
          					<div class="hotel-img" style="background-image: url(images/descrip/sawa/15.jpg);"></div>
          				</div>
          				<div class="item">
          					<div class="hotel-img" style="background-image: url(images/descrip/sawa/8.jpg);"></div>
          				</div>
          				<div class="item">
          					<div class="hotel-img" style="background-image: url(images/descrip/sawa/16.jpg);"></div>
          				</div>
          			</div>
          		</div>
          			...
          			<p class="rate mb-5">
          				...
          				<span class="star">
    						...
    						<div class="d-md-flex mt-5 mb-5">
    							<ul>
	    							<li>L’enseigne sawa Palace Douala est le fruit de la volonté,</li>
...
NB: Profitez d'une vue imprenable du fleuve Wouri à partir de notre bar-bibliothèque Réflexion.
          		...
          		<div class="col-md-12 hotel-single ftco-animate mb-5 mt-4">
        			...
        			<div class="block-16">
		              <figure>
		                <img src="video/img/16.jpg" alt="Image placeholder" class="img-fluid">
		                <a href="video/sawa.mp4" class="play-button popup-vimeo"><span class="icon-play"></span></a>
		              </figure>
		            </div>
          		</div>
          		<div class="col-md-12 hotel-single ftco-animate mb-5 mt-4">
          			...
          			<div class="row">
          				<div class="col-md-4">
				    				<div class="destination">
				    					<a href="#" class="img img-2" style="background-image: url(images/descrip/sawa/5.jpg);"></a>
				    					<div class="text p-3">
				    						<div class="d-flex">
				    							<div class="one">
				    						...
				    						<p>Chambre de luxe réservé uniquement pour vous!.</p>
				    						<hr>
				    						<p class="bottom-area d-flex">
				    							<span><img src="images/site/icon.jpg">Sawa</span>   
				    			...
				    			<div class="col-md-4">
				    				<div class="destination">
				    					<a href="#" class="img img-2" style="background-image: url(images/descrip/sawa/9.jpg);"></a>
				    					<div class="text p-3">
				    						<div class="d-flex">
				    							<div class="one">
						    						<h3><a href="#">Chambre</a></h3>
				    			...
				    			<div class="col-md-4">
				    				<div class="destination">
				    					<a href="#" class="img img-2" style="background-image: url(images/descrip/sawa/4.jpg);"></a>
				    					<div class="text p-3">
				    						<div class="d-flex">
				    							<div class="one">
						    						<h3><a href="#">Chambre</a></h3>
