          	...
          	<div class="row">
          		<div class="col-md-4 ftco-animate">
		    				<div class="destination">
		    					<a href="tourdes1.php" class="img img-2 d-flex justify-content-center align-items-center" style="background-image: url(images/bg/3.jpg);">
		    					...
		    					<div class="text p-3">
		    						<div class="d-flex">
		    							<div class="one">
				    						<h3><a href="toourdes1.php">monument de la reunification</a></h3>
		    						...
		    						<p>est l'oeuvre du francais salomon, du sculpteur camerounais gedeon.</p>
		    						<hr>
		    			...
		    			<div class="col-md-4 ftco-animate">
		    				<div class="destination">
		    					...
		    					<div class="text p-3">
		    						<div class="d-flex">
		    							<div class="one">
				    						<h3><a href="#">nouvelle liberte</a></h3>
		    						...
		    						<p>Monument celebre monte dans la ville de Douala par Joseph-Francis sumegne en 1996.</p>
		    						<hr>
		    						<p class="bottom-area d-flex">
									<span><img src="images/site/icon.jpg">Tourisme</span>
		    			...
		    			<div class="col-md-4 ftco-animate">
		    				<div class="destination">
		    					<a href="#" class="img img-2 d-flex justify-content-center align-items-center" style="background-image: url(images/bg/Le-parc-national-du-mban.jpg);">
		    						<div class="icon d-flex justify-content-center align-items-center">
    							<span class="icon-search2"></span>
    						</div>
		    					</a>
		    					<div class="text p-3">
		    						...
		    						<p>Ce parc cree en janvier 2000 au centre du cameroun. il s'etend sur d'autre regions</p>
		    						<hr>
		    						<p class="bottom-area d-flex">
		    							<span><img src="images/site/icon.jpg">Tourisme</span> 
		    							<span class="ml-auto"><a href="#">Découvrir</a></span>
		    			...
		    			<div class="col-md-4 ftco-animate">
		    				<div class="destination">
		    					<a href="#" class="img img-2 d-flex justify-content-center align-items-center" style="background-image: url(images/bg/dschang.jpg);">
		    						<div class="icon d-flex justify-content-center align-items-center">
    							<span class="icon-search2"></span>
    						</div>
		    					</a>
		    					<div class="text p-3">
		    						...
		    						<p>Dschang est une ville historique du cameroun et est constitue des montagnes</p>
		    						<hr>
		    						<p class="bottom-area d-flex">
		    							<span><img src="images/site/icon.jpg">Tourisme</span> 
		    							<span class="ml-auto"><a href="#">Découvrir</a></span>
		    			...
		    			<div class="col-md-4 ftco-animate">
		    				<div class="destination">
		    					<a href="#" class="img img-2 d-flex justify-content-center align-items-center" style="background-image: url(images/bg/baffou.jpg);">
		    						<div class="icon d-flex justify-content-center align-items-center">
    							<span class="icon-search2"></span>
    						</div>
		    					</a>
		    					<div class="text p-3">
		    						<div class="d-flex">
		    							<div class="one">
				    						<h3><a href="#">Chefferie Bafou</a></h3>
		    						...
		    						<p>Cette Chefferie a ete fondee vers 1520 par tala, chasseur venu de baleveng.</p>
		    						<hr>
		    						<p class="bottom-area d-flex">
		    							<span><img src="images/site/icon.jpg">Tourisme</span> 
		    							<span class="ml-auto"><a href="#">Découvrir</a></span>
		    			...
		    			<div class="col-md-4 ftco-animate">
		    				<div class="destination">
		    					<a href="#" class="img img-2 d-flex justify-content-center align-items-center" style="background-image: url(images/bg/6.jpg);">
		    						<div class="icon d-flex justify-content-center align-items-center">
    							<span class="icon-search2"></span>
    						</div>
		    					</a>
		    					<div class="text p-3">
		    						<div class="d-flex">
		    							<div class="one">
				    						<h3><a href="#">chefferie Bandjoun</a></h3>
		    						...
		    						<p>Situe a l'Ouest Cameroun, est un domaine en pays Bamileke, et constitue d'une foret royal.</p>
		    						<hr>
		    						<p class="bottom-area d-flex">
		    							<span><img src="images/site/icon.jpg">Tourisme</span> 
		    							<span class="ml-auto"><a href="#">Découvrir</a></span>
